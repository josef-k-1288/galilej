...
if( !class_exists( 'sheeba_lite_metaboxes' ) ) {

	class sheeba_lite_metaboxes {
		...
		public function __construct( $posttype, $fields = array() ) {
			...
			add_action( 'save_post', array( &$this, 'sheeba_lite_metaboxes_save' ) );
		}
		...
		public function metaboxes_panel() {
			...
			case 'navigation': ?>
				...
				<div id="tabs" class="sheeba_lite_metaboxes">
			...
			if (isset($field['type'])) : 
				...
				switch ( $field['type'] ) { 
					...
					<div class="sheeba_lite_inputbox">
						...
						<div class="input-right">
							...
							<input name="<?php echo esc_attr($field['id']); ?>" id="<?php echo esc_attr($field['id']); ?>" type="<?php echo esc_attr($field['type']); ?>" value="<?php if ( sheeba_lite_postmeta( $field['id']) != "") { echo esc_attr(sheeba_lite_postmeta( $field['id'])); } ?>" />
					...
					<div class="sheeba_lite_inputbox">
						...
						<div class="input-right">
							...
							<select name="<?php echo esc_attr($field['id']); ?>" id="<?php echo esc_attr($field['id']); ?>" >
								...
								<option <?php if ( sheeba_lite_postmeta($field['id']) == $option || ( !sheeba_lite_postmeta($field['id']) && $field['std'] == $option )) { echo 'selected="selected"'; } ?> value="<?php echo esc_attr($option); ?>"><?php echo esc_html($values); ?></option><?php } ?>  
					...
					<div class="sheeba_lite_inputbox">
                        ...
                        <div class="input-right">
                            ...
                            <textarea name="<?php echo esc_attr($field['id']); ?>" id="<?php echo esc_attr($field['id']); ?>" type="<?php echo esc_attr($field['type']); ?>" ><?php if ( sheeba_lite_postmeta( $field['id']) != "") { echo stripslashes(sheeba_lite_postmeta( $field['id'])); } ?></textarea>
		...
		public function sheeba_lite_metaboxes_save() {
