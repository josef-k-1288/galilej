	...
	class Sheebalite_Customize_Info_Control extends WP_Customize_Control {
		...
		public function render_content() { ?>
            ...
            <div class="inside">
				...
				<h2><?php esc_html_e('Sheeba premium version','sheeba-lite');?></h2> 

                <p><?php esc_html_e("Upgrade to the premium version of Sheeba, to enable 600+ Google Fonts, unlimited widget areas, portfolio section and much more.","sheeba-lite");?></p>
