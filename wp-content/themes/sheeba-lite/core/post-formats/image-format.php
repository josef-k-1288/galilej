...
if (!function_exists('sheeba_lite_image_format_function')) {

	function sheeba_lite_image_format_function() {
	...
	add_action( 'sheeba_lite_image_format', 'sheeba_lite_image_format_function' );
