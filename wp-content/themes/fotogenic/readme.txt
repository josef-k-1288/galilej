...
Tags:               photography, blog, portfolio, grid-layout, one-column, two-column, right-sidebar, left-sidebar, custom-background, custom-colors, custom-header, custom-logo, custom-menu, editor-style, footer-widgets, theme-options, translation-ready
...
Get free support at https://mysterythemes.com/support/forum/themes/free-themes/ and check the demo at https://demo.mysterythemes.com/fotogenic-landing/
...
Fotogenic WordPress Theme, Copyright 2018 Mystery Themes.
Fotogenic is distributed under the terms of the GNU GPL V3.
...
== Resources ==
    ...
    Mt Player By Matteo Bicocchi (Pupunzi)
    Licenses:  MIT, GPL
	...
	https://pxhere.com/en/photo/1265361
...
= 1.0.6 = 12th July
    * Added scripts for masonry layout in gallery page.
    * Added scripts for Prettyphoto in gallery page.
    * fotogenic.pot file update.

= 1.0.5 =
    * Archive page code change for post content display.
    * Text field added for portfolio sub title in customizer.
